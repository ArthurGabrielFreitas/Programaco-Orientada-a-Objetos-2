...
public class Teste {
    ...
    static Item[] criaItens(Parte[] partes) {
        return new Item[] {
            new Item(partes[0], 10),  // motor m112, qtd 10
            new Item(partes[5], 50),  // parafuso p2, qtd 50
            new Item(partes[7], 30),  // parafuso p4, qtd 30
            new Item(partes[2],  5)   // motor m111, qtd 5
        };
    }
